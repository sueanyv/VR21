const addForm = document.querySelector("#addalbum form");
...
//album card html template
function createAlbumCard (cardInfo) {
...
colCard.querySelector(".card-img-top").setAttribute("src", cardInfo.albumUrl);   
